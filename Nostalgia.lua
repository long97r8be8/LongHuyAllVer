...
local Window = Fluent:CreateWindow({
    Title = "Nostalgia Hub | Blox Fruits",
    SubTitle = "",
    TabWidth = 155,
...
------Bypass TP 2
 function GetIsLand(...)
    ...
    if game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Health == 0 then
        ...
        repeat wait(0.2) until game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Health > 0; wait(0.2)
    end
    local tweenfunc = {}
...
ImageButton1.Image = "rbxassetid://130155236743364"
...
local Farming = Tabs.Main:AddSection("Farming")
    ...
    spawn(function()
        ...
        local ToggleCandy = Tabs.Main:AddToggle("ToggleCandy", {Title = "Auto Candies ( Wait Event Chrismas Back ! )",Description = "Cày Kẹo ( Đợi Sự kiện Trở Lại ! )", Default = false })
									  ...
									  if v.Name == "Isle Outlaw" or v.Name == "Island Boy" or v.Name == "Sun-kissed Warrior" or v.Name == "Isle Champion" then
										 if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
											 repeat wait(getgenv().Fast_Delay)
												 ...
												 FarmPos = v.HumanoidRootPart.CFrame
												 MonFarm = v.Name
											  until not getgenv().AutoCandy or not v.Parent or v.Humanoid.Health <= 0
                                              bringmob = false
                                            end
									  end
								  end
							...
							for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do 
								if v.Name == "Cake Prince" then
                                    repeat wait(getgenv().Fast_Delay)
										...
										v.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
										v.HumanoidRootPart.CanCollide = false
										Tween(v.HumanoidRootPart.CFrame * Random)
										--Click
...
InterfaceManager:SetFolder("Fai Fao Hub")
SaveManager:SetFolder("Fai Fao Hub/specific-game")
