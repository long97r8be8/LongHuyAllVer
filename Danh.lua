...
ImageButton.Image = "http://www.roblox.com/asset/?id=129543771609247"
...
local listfastattack = {'Normal Attack','Fast Attack','Super Fast Attack'}
    ...
    local ToggleAutoClick = Tabs.Main:AddToggle("ToggleAutoClick", {Title = "Auto Click",Description = "", Default = false })
    ToggleAutoClick:OnChanged(function(Value)
       _G.AutoClick = Value
       if Value == false then
        end
    end)
    Options.ToggleAutoClick:SetValue(false)
